            ...
            <div className='Footer-Parent max-w-[1400px] mx-auto flex flex-col gap-10 sm:flex-row md:justify-between md:gap-0'>
                  <div className='First-Child flex flex-col items-start gap-2 bg--300'>
                        <a href='/' className='Company-Name&Logo flex items-center justify-center gap-2'>
                            <img src='/images/E-2.png' alt='logo' width={60} className='xl:w-16'/>
                            <h1 className='font-bold text-2xl xl:text-3xl'>Easy UI</h1>
                        </a>
                        ...
                        <button className='whitespace-nowrap text-sm xl:text-base flex items-center gap-2 bg-slate-900 text-white py-2 px-4 rounded-md'>Share Your Thoughts On <FontAwesomeIcon icon={faLinkedin} className='text-lg'/> </button>
                  </div>
