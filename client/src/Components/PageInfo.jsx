...
const PageInfo = () => {
  return (
    <div className='flex flex-col items-center gap-4'>
            <div className='Why-box bg-[#865D36] w-[85%] flex flex-col gap-2 p-3 rounded-md mt-2'>
            ...
            <div className='Card rounded-md border-[1px] border-[#865D36] bg-[] w-[85%] flex flex-col items-center'>
            ...
            <div className='Card-2 rounded-md border-[1px] border-[#865D36] bg-[] w-[85%] flex flex-col items-center'>
