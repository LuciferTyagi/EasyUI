...
const rotatingBg = useTransform(rotate,(r) =>{
  ...
  return (
    <section className='w-full  px-4 py-20 font-inter bg-red-300'>
             <div className='Parent w-full  max-w-[1400px]   mx-auto flex flex-col gap-4 bg-pnk-300'>
                    ...
                    <div className='Second-Child Component-Card bg--300 border-[1px] border-zinc-300 rounded-xl p-4 shadow-md'>
                        ...
                        <div className='grid grid-cols-1 gap-2'>
                             <div href='/components' className='border-[1px] rounded-xl border-zinc-500 bg--400 h-[200px] flex items-center px-4   '>
                                <span>Standard Accordion</span>
                                <StandardAccordion/>
                             </div>
                             <div href='/components' className='border-[1px] rounded-xl border-zinc-500 bg--400 h-[200px] flex items-center px-4   '>
                                <MultiExpandableAccordion/>
                             </div>
                             <div href='/components' className='border-[1px] rounded-xl border-zinc-500 bg--400 h-[200px] flex items-center px-4   '>
                                <SimpleAlert/>
                             </div>
